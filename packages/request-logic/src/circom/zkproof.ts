...
async function generateProof(
  ...
  const { proof, publicSignals } = await snarkjs.groth16.fullProve(
    inputs,
    // TODO relative path
    `/home/vincent/Documents/request/link/requestnetwork/packages/request-logic/src/circom/${name}.wasm`,
    `/home/vincent/Documents/request/link/requestnetwork/packages/request-logic/src/circom/${name}_final.zkey`,
  );
